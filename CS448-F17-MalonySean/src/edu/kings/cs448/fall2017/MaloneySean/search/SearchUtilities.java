...
public class SearchUtilities {
	 ...
	 * @param choices A map of algorithm names to algorithm objects.
	...
	/**
	 * Gets a map of algorithms and their names for solving a specific problem type.
	 * 
	 * @param <S> The type of states in the problem.
	 * @param <A> The type of actions in the problem.
	 ...
	 * 
	 * @param <A> The type of actions in the problem.
	 * @param solution A sequence of actions that solves the problem, or null if there is no solution.
	 */
