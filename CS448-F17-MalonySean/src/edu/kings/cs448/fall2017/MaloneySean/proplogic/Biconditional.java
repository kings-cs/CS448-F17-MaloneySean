...
public class Biconditional extends BinaryOperator {
	 ...
	 * 
	 * @param one The first Sentence.
	 * @param two The second Sentence.
	 */
	...
	public boolean equals(Object other) {
		...
		if(other == null) {
			...
			result = (getFirst().equals(((Biconditional)other).getFirst()) && getSecond().equals(((Biconditional)other).getSecond())) ||
					(getFirst().equals(((Biconditional)other).getSecond()) && getSecond().equals(((Biconditional)other).getFirst()));
		}
		return result;
	...
	protected Sentence afterBiconditionalElimination() {
		...
		after.addSentence(new Implication(getFirst().afterBiconditionalElimination(), getSecond().afterBiconditionalElimination()));
		after.addSentence(new Implication(getSecond().afterBiconditionalElimination(), getFirst().afterBiconditionalElimination()));
		return after;
	}
