...
//				if(problem.getDomains().get(current.getVarOne()).size() == 0) {
//					result = false;
//				}
	...
	/**
	 * Private helper method to determine what elements need to be removed from the domain.
	 * @param problem The CSP.
	 * @param xI The first variable to be checked.
	 ...
	 * @param secondVar The variable to be the second part of the ordered pairs.
	 * @param pairs The set containing the ordered pairs.
	 */
