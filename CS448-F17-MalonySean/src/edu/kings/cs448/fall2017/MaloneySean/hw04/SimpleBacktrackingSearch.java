...
public class SimpleBacktrackingSearch implements CSPSolver {
	 ...
	 * 
	 * @param problem The CSP that is being solved.
	 * @param assignment The partial solution so far.
	 ...
	 * 
	 * @param problem A CSP to solve.
	 * @param assignment A consistent assignment for that problem.
	 * @return A solution that is a descendant of the assignment, or null if none exists.
	 */
	private Map<String, Object> solve(ConstraintSatisfactionProblem problem, Map<String, Object> assignment) {
		...
		if(problem.isComplete(assignment)){
			...
			// We need to iterate over a copy, because otherwise there will be ConcurrentModificationExceptions.
	...
	/**
	 * Does any kind of extra checking of whether or not to proceed with adding to a partial solution.
	 * This method exists for subclasses to override if they want special processing.
	 * 
	 * @param problem The CSP being solved.
	 * @param assignment The current assignment.
	 * @param mostRecentVar The variable that was most recently added to the assignment.
	 * @return Whether or not it is worth making a recursive call with this assignment.
	 */
	public boolean extraCheck(ConstraintSatisfactionProblem problem, Map<String, Object> assignment, String mostRecentVar) {
		return true;
	}
}
