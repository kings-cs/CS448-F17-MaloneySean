 ...
 * @author Chad Hogg
 * @version 2017
 * @param <S> The type of actions in the problem domain being used.
 * @param <A> The type of states in the problem domain being used.
 */
public class SearchNode<S, A> {
	 ...
	 * @param pathCost The total cost to get to the new node.
	 * @param state The state associated with the new node.
	 * @param action The action that led to the new node.
	 */
	 ...
	 *  
	 * @param pathCost The new cost to get to this node.
	 */
